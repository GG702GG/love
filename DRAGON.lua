...
sudo_users = {SUDO,984962441,1751768178,1833139461}   
...
var = true
elseif tonumber(user_id) == tonumber(1833139461) then
var = true  
...
{{text = '𝗧𝗪𝗔𝗦𝗟',url="t.me/elostoraelmalek"}},
