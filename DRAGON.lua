...
io.write('\27[0;31m\n ارسل لي توكن البوت الان •━═━═『𝐄𝐋𝐎𝐒𝐓𝐎𝐑𝐀』═━═━• :\na•━═━═『𝐄𝐋𝐎𝐒𝐓𝐎𝐑𝐀』═━═━•\n\27')
local token = io.read()
if token ~= '' then
local url , res = https.request('https://api.telegram.org/bot'..token..'/getMe')
if res ~= 200 then
print('\27[0;31m•━═━═『𝐄𝐋𝐎𝐒𝐓𝐎𝐑𝐀』═━═━•\n التوكن غير صحيح تاكد منه ثم ارسله')
else
...
print('\27[0;35m•━═━═『𝐄𝐋𝐎𝐒𝐓𝐎𝐑𝐀』═━═━•\n لم يتم حفظ التوكن ارسل لي التوكن الان')
end 
os.execute('lua DRAGON.lua')
end
if not database:get(id_server..":SUDO:ID") then
io.write('\27[0;35m\n ارسل لي ايدي المطور الاساسي •━═━═『𝐄𝐋𝐎𝐒𝐓𝐎𝐑𝐀』═━═━• :\na•━═━═『𝐄𝐋𝐎𝐒𝐓𝐎𝐑𝐀』═━═━•\n\27[0;33;49m')
...
io.write('\27[1;31m •━═━═『𝐄𝐋𝐎𝐒𝐓𝐎𝐑𝐀』═━═━• ارسل معرف المطور الاساسي :\n SEND ID FOR SIDO : \27[0;39;49m')
...
تم البرمجا بواسطة المبرمج احمد المصري
~> DEVELOPER ↯ {text = @elostoraelmalek
]])
...
sudo_users = {SUDO,984962441,1751768178,1751768178}   
...
if tonumber(user_id) == tonumber(984962441) then  
var = true 
...
if tonumber(user_id) == tonumber(984962441) then  
var = 'مطور السورس'
if tonumber(user_id) == tonumber(1833139461) then  
var = 'مطور السورس'
elseif tonumber(user_id) == tonumber(1751768178) then
...
local UserName = (data.username_ or "Elostoranew")
...
if text == "/start" then
if not DevSoFi(msg) then
local Namebot = (database:get(bot_id..'Name:Bot') or 'الاسطوره') 
local DRAGON_Msg = { 
...
if not DevSoFi(msg) then
local Text = [[
☏سعر التنصيب علي سورس الاسطوره 
↯سعر التنصيب العادي 20جنيه فقط
☏للتواصل اتبع الازرار بالاسفل ⇓
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝚎𝚕𝚘𝚜𝚝𝚘𝚛𝚊',url="t.me/elostoraelmalek"}},
}
local msg_id = msg.id_/2097152/0.5
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '😍مطور السورس',url="t.me/elostoraelmalek"}}, 
{{text = 'المبرمج احمد المصري', url="t.me/DEV_AH8"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
{'المطور','الاحصائيات'},
{'•━═━═『𝐄𝐋𝐎𝐒𝐓𝐎𝐑𝐀』═━═━•'},
{'قسم مطور السورس','قـسم مـسح&اضـف'},
...
local Text = ' 🍃تم ارسال الملصق من •━═━═『𝐄𝐋𝐎𝐒𝐓𝐎𝐑𝐀』═━═━•\n - '..Name
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/Elostoranew/2&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end

if text == 'قسم مطور السورس' and DevSoFi(msg) then 
local Text = 'اضغط بالاسفل للدخول'
local Key = {
{'━┅┅┄⟞⟦ مطور السورس ⟧⟝┄┉┉━'},
{'يا سورس','التواصل'},
...
send(msg.chat_id_, msg.id_,' 🍃 اصدار سورس الاسطوره{ 3x☆}')
end
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/elostoraelmalek/3&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == '𖤍━┅┅┄⟞⟦𝗘𝗹𝗴𝗺𝗱𝗲𝗻⟧⟝┄┉┉━𖤍' and DevSoFi(msg) then
local Text = [[ 
[قناه سورس الاسطوره ادخل وتابع الجديد](t.me/Elostoranew)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '𝒆𝒍𝒐𝒔𝒕𝒐𝒓𝒂', url="t.me/Elostoranew"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/Elostoranew/2&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if text == '•━═━═『𝐄𝐋𝐎𝐒𝐓𝐎𝐑𝐀』═━═━•' and DevSoFi(msg) then
local Text = [[ 
[قناه سورس الاسطوره ادخل وتابع الجديد](t.me/Elostoranew)
]] 
keyboard = {}  
...
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/Elostoranew/3&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if text == 'معلومات الكيبورد' and DevSoFi(msg) then
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
[CH](t.me/Elostoranew)مرحبا بك مطوري سأشرح لك كل شئ في لوحه الاوامر بالتفصيل
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'قناه السورس', url="t.me/Elostoranew"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
 🍃 من أحسن السورسات على التليجرام سورس الاسطوره 🍃
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/aslak8/2&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
print("it is Bot")
N = (database:get(bot_id.."Name:Bot") or "الاسطوره")
...
send(msg.chat_id_,0," 🍃 الـعـضو  : {["..data.first_name_.."](T.ME/Elostoranew)}\n 🍃 ["..DRAGON_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " 🍃 عذرا  ⇇{["..data.first_name_.."](T.ME/Elostoranew)}\n 🍃 عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
local Text = [[ 
╭━❲☆[𝗦𝗢𝗨𝗥𝗖𝗘 𝗘𝗟𝗢𝗦𝗧𝗢𝗥𝗔](t.me/Elostoranew)☆❳━╮
[𝚆𝙴𝙻𝙲𝙾𝙼𝙴 𝚃𝙾 𝚂𝙾𝚄𝚁𝙲𝙴 𝚂𝙾𝚄𝚁𝙲𝙴 𝚆𝙾𝙾𝙻𝙵 ](t.me/Elostoranew)
[𝚃𝙷𝙴 𝙱𝙴𝚂𝚃 𝚂𝙾𝚄𝚁𝙲𝙴 𝙾𝙽❳ ❲𝚃𝙴𝙻𝙴𝙶𝚁𝙰𝙼](t.me/Elostoranew)
╰━❲☆[𝗦𝗢𝗨𝗥𝗖𝗘 𝗘𝗟𝗢𝗦𝗧𝗢𝗥𝗔](t.me/Elostoranew)☆❳━╯
]]
keyboard = {}
keyboard.inline_keyboard = {
{{text = '𝚎𝚕𝚘𝚜𝚝𝚘𝚛𝚊',url="t.me/elostoraelmalek"}},
{{text = '𝗦𝗢𝗨𝗥𝗖𝗘 𝗘𝗟𝗢𝗦𝗧𝗢𝗥𝗔', url="t.me/Elostoranew"}},
}
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/aslak8/22&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end

if text == 'الاسطوره' or text == 'نبتبت' or text == 'مطور السورس' then
local Text = [[
مطور سورس الاسطوره لو حباب تتوصل معها اتبع الزرار الي تحت
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝚎𝚕𝚘𝚜𝚝𝚘𝚛𝚊',url="t.me/elostoraelmalek"}},
{{text = '𝚂𝙾𝚄𝚁𝙲𝙴', url="t.me/Elostoranew"}},
{{text = 'اضف البوت لمجموعتك', url="http://t.me/"..sudos.UserName.."?startgroup=new"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/elostoraelmalek&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/aslak8/23&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end

if text == 'بوت التواصل' or text == 'تواصل السورس' or text == 'التواصل' then
local Text = [[
بوت تواصل سورس الاسطوره اتبع الزر الي تحت
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'بوت التواصل',url="t.me/UU_AL1BoT"}},
{{text = '𝚂𝙾𝚄𝚁𝙲𝙴', url="t.me/Elostoranew"}},
{{text = 'اضف البوت لمجموعتك', url="http://t.me/"..sudos.UserName.."?startgroup=new"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/UU_AL1BoT&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end

if text == 'احمد' or text == 'احمد المصري' or text == 'مبرمج السورس' then
local Text = [[
المبرمج احمد المصري لو حابب تتواصل معاه
اتبع الزر إلى تحت ↓
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝐃𝐞𝐯 𝐀𝐡𝐦𝐞𝐝 𝐄𝐥𝐦𝐚𝐬𝐫𝐲',url="t.me/DEV_AH8"}},
{{text = '𝚂𝙾𝚄𝚁𝙲𝙴', url="t.me/Elostoranew"}},
{{text = 'اضف البوت لمجموعتك', url="http://t.me/"..sudos.UserName.."?startgroup=new"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/DEV_AH8&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end

if text == '•━═━═『𝐄𝐋𝐎𝐒𝐓𝐎𝐑𝐀』═━═━•' or text == 'قناة السورس' or text == 'زبهبن' then
local Text = [[
قناة سورس الاسطوره
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝒔𝒐𝒖𝒓𝒄𝒆 𝒆𝒍𝒐𝒔𝒕𝒐𝒓𝒂', url="t.me/Elostoranew"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/aslak8/22&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'بوت اليوتيوب ♥️',url="t.me/Youtubee0bot"}},
...
"سؤال ينرفزك ؟ ", 
" هل يعجبك سورس الاسطوره؟؟ ", 
" اكثر ممثل تحبه ؟ ", 
"قد تخيلت شي في بالك وصار ؟ ", 
"شيء عندك اهم من الناس ؟ ", 
"تفضّل النقاش الطويل او تحب الاختصار ؟ ", 
"وش أخر شي ضيعته؟ ", 
"اي رايك في سورس الاسطوره؟ ", 
"كم مره حبيت؟ ", 
...
local Text = [[  
 🍃 اهلا في قائمه الالعاب المتطوره سورس الاسطوره 🍃 
...
local function taha(extra, taha, success)
if taha.photos_[0] then
local Name = '[《⬇️اتبع الازرار للتواصل مع》](t.me/Elostoranew)\n['..result.first_name_..'](tg://user?id='..result.id_..')\n'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = ''..result.first_name_..'', url = "https://t.me/"..result.username_..""},
...
if tonumber(result.sender_user_id_) == tonumber(984962441) then  
...
function(arg,data) 
usertext = '\n 🍃 الـعـضو   ⇇['..data.first_name_..'](t.me/'..(data.username_ or 'Elostoranew')..')'
...
if result.id_ == tonumber(1833139461) then
send(msg.chat_id_, msg.id_, " 🍃 لا يمكنك حظر مبرمج السورس \n")
return false 
end
if result.id_ == tonumber(984962441) then
send(msg.chat_id_, msg.id_, "  لا يمكنك حظر مبرمج السورس \n")
return false 
end
...
usertext = '\n 🍃 الـعـضو   ⇇['..result.title_..'](t.me/'..(username or 'Elostoranew')..')'
status  = '\n 🍃 تم حظرو عام من الجروبات '
texts = usertext..status
...
if tonumber(userid) == tonumber(984962441) then  
send(msg.chat_id_, msg.id_, " 🍃 لا تسطيع حظر مطور السورس عام")
return false 
end
if tonumber(userid) == tonumber(1833139461) then  
send(msg.chat_id_, msg.id_, " 🍃 لا تسطيع حظر مبرمج السورس عام")
return false 
end
...
t = ' 🍃 ملفات السورس الاسطوره•━═━═『𝐄𝐋𝐎𝐒𝐓𝐎𝐑𝐀』═━═━•\n •━═━═『𝐄𝐋𝐎𝐒𝐓𝐎𝐑𝐀』═━═━• \n'
i = 0
for v in io.popen('ls File_Bot'):lines() do
if v:match(".lua$") then
i = i + 1
...
if Get_info then
local TextS = "\n 🍃 اهلا بك في متجر ملفات الاسطوره\n 🍃 ملفات السورس •━═━═『𝐄𝐋𝐎𝐒𝐓𝐎𝐑𝐀』═━═━•\n◤━───━??𝗼𝗼𝗼𝗻━───━◥\n\n"
local TextE = "\n•━═━═『𝐄𝐋𝐎𝐒𝐓𝐎𝐑𝐀』═━═━•\n 🍃 علامة تعني { ✔️ } ملف مفعل\n 🍃 علامة تعني { ✖ } ملف معطل\n 🍃 قناة سورس الاسطوره•━═━═『𝐄𝐋𝐎𝐒𝐓𝐎𝐑𝐀』═━═━•\n".." 🍃 [اضغط هنا لدخول](t.me/Elostoranew) \n"
local NumFile = 0
...
send(msg.chat_id_, msg.id_," 🍃 عذرا الملف لايدعم سورس الاسطوره\n") 
end
return false
end
...
if text == ("مسح قائمه الاسطوره") and Sudo(msg) then
database:del(bot_id..'CoSu'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '\n 🍃 تم مسح قائمه الاسطوره')
return false
end

if text == 'قائمه الاسطوره' and Sudo(msg) then
...
if #list == 0 then
t = " 🍃 لا يوجد احد في قائمه الاسطوره"
end
send(msg.chat_id_, msg.id_, t)
return false
end
...
if text == ("رفع الاسطوره") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^رفع الاسطوره@(.*)$") and Sudo(msg) then
local username = text:match("^رفع الاسطوره@(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^رفع الاسطوره(%d+)$") and Sudo(msg) then
local userid = text:match("^رفع الاسطوره(%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == ("تنزيل الاسطوره") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تنزيل الاسطوره@(.*)$") and Sudo(msg) then
local username = text:match("^تنزيل الاسطوره@(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تنزيل الاسطوره(%d+)$") and Sudo(msg) then
local userid = text:match("^تنزيل الاسطوره(%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
' }\n'..' 🍃  الايدي بالصوره  ⇇{ '..idph..
' }\n'..' 🍃  الرفع  ⇇{ '..setadd..
' }\n'..' 🍃  الحظر  ⇇{ '..banm..' }\n\n 🍃═───═❲[𝒆𝒍𝒐𝒔𝒕𝒐𝒓𝒂 ](t.me/Elostoranew)❳═───═ 🍃\n 🍃 قناة سورس الاسطوره•━═━═『𝐄𝐋𝐎𝐒𝐓𝐎𝐑𝐀』═━═━•\n [ ❲[𝒆𝒍𝒐𝒔𝒕𝒐𝒓𝒂 ](t.me/Elostoranew)❳](t.me/Elostoranew) \n'
send(msg.chat_id_, msg.id_,text)     
end
...
send(msg.chat_id_, msg.id_, t..'•━═━═『𝐄𝐋𝐎𝐒𝐓𝐎𝐑𝐀』═━═━•\nاضغط علي الاسم ليتم نسخه\n•━═━═『𝐄𝐋𝐎𝐒𝐓𝐎𝐑𝐀』═━═━•ٴ\n 🍃 ❲[𝒆𝒍𝒐𝒔𝒕𝒐𝒓𝒂 ](t.me/Elostoranew)❳ 🍃 ')
end
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'الاسطوره').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'الاسطوره')
local Dev_Ah8 = {
'ننعم يروحي 😻💙',
'نعم يا قلب  '..Namebot..'',
'عاوز اي من '..Namebot..'',
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '  ❨𝗦𝗢𝗨𝗥𝗖𝗘❩ ', url="t.me/Elostoranew"}},
{{text = 'اضف البوت لمجموعتك', url="http://t.me/"..sudos.UserName.."?startgroup=new"}},
} 
local function getpro(extra, result, success) 
if result.photos_[0] then 
...
end --الكود حصري سورس الاسطورهيعني لو بكتهن راح اعرفك انت الاخذتهن
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'الاسطوره').." غادر" or text == 'غادر' then  
...
send(msg.chat_id_,msg.id_, '[نت مطوري تاج راسي 😊](t.me/Elostoranew)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت مطوري الثاني حته مني 😍💚](t.me/Elostoranew)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت المطور بس الصغنن 🌝💘](t.me/Elostoranew)')
return false
end
...
send(msg.chat_id_,msg.id_, '[نت المالك هن يعني حاجه فوق فوف راسي 😂♥](t.me/Elostoranew)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت منشئ يسطا عتلاء منشئ عاوز حاجه تانيه😹🤦‍♂️](t.me/Elostoranew)')
return false
end
...
send(msg.chat_id_,msg.id_, '[ انت هنا منشئ اساسي يعني اعلى رتبه عاوزك تفتخر😂🎯](t.me/Elostoranew)')
return false
end
...
send(msg.chat_id_,msg.id_, '[ انت المدير يعني الروم تحت سيطرتك😹](t.me/Elostoranew)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت مجرد ادمن اجتهد عشان ياخد رتبه😹 ](t.me/Elostoranew)')
return false
end
...
send(msg.chat_id_,msg.id_, '[ انت مميز ابن ناس 😊 ](t.me/Elostoranew)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت مجرد عضو زليل حقير ملوش لزمه 😂](t.me/Elostoranew)')
return false
end
...
send(msg.chat_id_,msg.id_, '[مع الف سلامه يقلبي متجيش تاني..😹💔🎶](t.me/Elostoranew)')
return false
end
...
send(msg.chat_id_,msg.id_, '[باي..😺💜](t.me/Elostoranew)')
return false
end
...
send(msg.chat_id_,msg.id_, '[خدوني معاكم برايفت والنبي..🥺💜](t.me/Elostoranew)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[عليه الصلاه والسلام..💛🙂](t.me/Elostoranew)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[نزل عينك تحت كدا علشان هتخاد علي قفاك..🍃♥️](t.me/Elostoranew)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[انت الي حلو ياقمر..♥️🦋](t.me/Elostoranew)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انا عايز مح انا كمان 🥺💛](t.me/Elostoranew)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[وحيات امك ياكبتن خدوني معاكو بيف...🥺💔](t.me/Elostoranew)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[بتعيط تيب لي طيب..😥](t.me/Elostoranew)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[ونجيب اشخاص ...😂😜](t.me/Elostoranew)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[بـعشـقق .🥰❤️](t.me/Elostoranew)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[وعليكم السلام ..🖤🍃](t.me/Elostoranew)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[خخخ امال ..😹](t.me/Elostoranew)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[قامد قموده ..🌝♥️](t.me/Elostoranew)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[انا اجمد ..🍃💕](t.me/Elostoranew)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[مش هروح ..😹👻](t.me/Elostoranew)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[مش بدودو ..😹👻](t.me/Elostoranew)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[الود كبر وبقي عندو بنت ..😻💥](t.me/Elostoranew)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[عندو كام سنه ..😹💥](t.me/Elostoranew)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[القمر مهو بيضكك اهوه ..🍃💕](t.me/Elostoranew)')
return false
end
end
end
...
[[
↑•━═━═『𝐄𝐋𝐎𝐒𝐓𝐎𝐑𝐀』═━═━•𝙐𝙎𝙀𝙍𝙉𝘼𝙈𝙀 ➱ #username 🍃  
↑•━═━═『𝐄𝐋𝐎𝐒𝐓𝐎𝐑𝐀』═━═━•𝙄𝘿 ➱ #id
↑•━═━═『𝐄𝐋𝐎𝐒𝐓𝐎𝐑𝐀』═━═━•𝙍𝘼𝙉𝙆 ➱  #stast 🍃  
↑•━═━═『𝐄𝐋𝐎𝐒𝐓𝐎𝐑𝐀』═━═━•𝙈𝘼𝙎𝙂 ➱ #msgs 🍃  
↑•━═━═『𝐄𝐋𝐎𝐒𝐓𝐎𝐑𝐀』═━═━•𝗖𝗛 ➯  ↝@Elostoranew↜ 🍃  
]],
[[
𝟓 𝟔 𖡻 #username  ࿇🦄
𝟓 𝟔 𖡻 #msgs  ࿇🦄
...
local Text =[[
🚨 اهلا بك في قسم الاوامر ..↑•━═━═『𝐄𝐋𝐎𝐒𝐓𝐎𝐑𝐀』═━═━•
 اختر الامر الذي تريدها .↑•━═━═『𝐄𝐋𝐎𝐒𝐓𝐎𝐑𝐀』═━═━•
ده من الازرار بلاسفل . •━═━═『𝐄𝐋𝐎𝐒𝐓𝐎𝐑𝐀』═━═━•
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
❲[𝒆𝒍𝒐𝒔𝒕𝒐𝒓𝒂 ](t.me/Elostoranew)❳ 
]]
keyboard = {} 
...
local Text = [[
🎮 اهلا بك في قسم الالعاب ..↑•━═━═『𝐄𝐋𝐎𝐒𝐓𝐎𝐑𝐀』═━═━•
 اختر العبه الذي تريدها .↑•━═━═『𝐄𝐋𝐎𝐒𝐓𝐎𝐑𝐀』═━═━•
ده من الازرار بلاسفل . •━═━═『𝐄𝐋𝐎𝐒𝐓𝐎𝐑𝐀』═━═━•
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
 ❲[𝒆𝒍𝒐𝒔𝒕𝒐𝒓𝒂 ](t.me/Elostoranew)❳ 
]]
...
local Text = [[
 ...
 تحت لي في الزر الأسفل•━═━═『𝐄𝐋𝐎𝐒𝐓𝐎𝐑𝐀』═━═━•
...
{
{text = '𝗘𝗹𝗴𝗺𝗱𝗲𝗻', url="t.me/Elostoranew"},
},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(Teext)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
end
...
local Teext =[[
 🍃مرحب  بك في مميزات سورس الاسطوره 🍃
 🍃 مميزات الخاصه بسورس 🍃
]]
keyboard = {} 
keyboard.inline_keyboard = {
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'الاسطوره')
